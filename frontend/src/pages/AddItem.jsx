    ...
    <div className="flex justify-center items-center flex-col p-6 bg-gradient-to-br from-orange-50 relative to-white min-h-screen">
      ...
      >
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 
                border rounded-lg focus:ring-2 focus:ring-orange-500"
          ...
          font-semibold shadow-md hover:bg-orange-600 hover:shadow transition-all duration-200 cursor-pointer"
          disabled={loading}>
