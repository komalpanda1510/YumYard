        ...
        >
          ...
          <div className="w-[80%] flex items-center gap-[10px]">
            ...
            <input
              ...
              className="
            px-[10px] text-gray-700 outline-0 w-full"
            />
          </div>
        </div>
      )}
...
<div className="relative cursor-pointer">
      ...
      text-[#ff4d2d] text-sm font-medium"
        ...
        <div
          className="w-[40px] h-[40px] rounded-full items-center flex justify-center
      bg-[#ff4d2d] text-white text-[18px] shadow-xl cursor-pointer font-semibold"
        ...
        {showInfo && (
          <div
            className="fixed top-[80px] right-[10%] md:right-[25%] w-[180px] bg-white shadow-2xl 
      rounded-xl p-[20px] flex flex-col gap-[10px] z-[9999]"
          >
            <div className="text-[17px] font-semibold">{userData.fullName}</div>
            {userData.role == "user" &&  <div className="md:hidden text-[#ff4d2d] fpnt-semibold cursor-pointer">
              My Orders
            </div>}
